	...
	<div class="header">
		<div class="headertop_desc">
			...
			<div class="account_desc">
				<ul>
					<li><a href="<%=request.getContextPath()%>/user/register">Register</a></li>
	...
	<div class="header_slide">
			<div class="header_bottom_left">				
				<div class="categories">
				  <ul>
				  	<h3>Categories</h3>
                                        <li><a href="<%=request.getContextPath()%>/category/products?id=MobilePhone">Mobile Phones</a></li>
				       <li><a href="<%=request.getContextPath()%>/category/products?id=Desktop">Desktop</a></li>
				       <li><a href="<%=request.getContextPath()%>/category/products?id=Laptop">Laptop</a></li>
				       <li><a href="<%=request.getContextPath()%>/category/products?id=Accessories">Accessories</a></li>
