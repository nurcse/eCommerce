...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    <a href="<%//=request.getContextPath()%>/category/products?id=MobilePhone" class="list-group-item">Mobile Phones</a>
                    <a href="<%//=request.getContextPath()%>/category/products?id=Desktop" class="list-group-item">Desktop</a>
                    <a href="<%//=request.getContextPath()%>/category/products?id=Laptop" class="list-group-item">Laptop</a>
                    <a href="<%//=request.getContextPath()%>/category/products?id=Accessories" class="list-group-item">Accessories</a>
                </div>
            </div>
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="<%//=request.getContextPath()%>/<%//=img %>" alt="">
                            <div class="caption">
                                <h4 class="pull-right">$<%//=result.getDouble("product_price")%></h4>
                                <br>
                                <h4><a href="<%//=request.getContextPath()%>/product/preview?id=<%//=result.getInt("product_id")%>"><%//=result.getString("product_name")%></a>
                                </h4>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="<%//=request.getContextPath()%>/images/preview.jpg" alt="">
                            <div class="caption">
    ...
    <form class="form-horizontal" name="profile" onsubmit="return validateProfileForm()" action="<%=request.getContextPath()%>/Home" method="doGet" role="form">
            <fieldset>
                ...
                <!-- Button -->
                <div class="form-group">
                    <label class="col-md-4 control-label" for="singlebutton">Your order has been received. Someone will contact you within 24 hours. Thankyou !!</label>
                    <div class="col-md-5">
                        <button type="submit" name="singlebutton" class="btn btn-primary">Ok</button>
                    </div>
                </div>
