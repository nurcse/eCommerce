  ...
  <div class="wrap">
	<div class="header">
		...
		<div class="header_top">
			<div class="logo">
				<a href="<%=request.getContextPath()%>/Home"><img src="images/logo.png" alt="" /></a>
			</div>
			  <div class="cart">
 ...
 <div class="main">
   ...
   <div class="footer">
        ...
        <div class="copy_right">
				<p>Company Name © All rights Reseverd | Developed by  <a href="https://www.facebook.com/3rdNormalForm">Nur Uddin</a> </p>
		   </div>
    </div>
   <script type="text/javascript">
